...
The user can click on a book in the stack and view the book information, including how long it has been since the book was added to the TBR pile. The User can mark books as "read", which will then display the date the status was updated. They can use the filter button to filter books by their "read" status. 
